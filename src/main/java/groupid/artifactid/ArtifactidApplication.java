...
public class ArtifactidApplication {
    ...
    CommandLineRunner commandLineRunner(StudentRepository studentRepository, StudentIdCardRespository studentIdCardRespository) {
        return args -> {
            ...
            //Creamos inscripción
            student.addEnrolment(new Enrolment(new EnrolmentId(1L, 1L), student, new Course("Dearone JPA Spring BOOT", "IT"), LocalDateTime.now().minusDays(18)));


            //Creamos inscripción 2
            student.addEnrolment(new Enrolment(new EnrolmentId(1L, 2L), student, new Course("Dearone JPA Spring BOOT", "IT"), LocalDateTime.now().minusDays(18)));
